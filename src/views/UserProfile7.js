  ...
  useEffect(async () => {
    ...
    const axiosPosts = async () => {
      const response = await axios.get(
        "http://tourbook-backend.herokuapp.com/api/transactions/mine",
        { headers: { "x-auth-token": token } }
      );
      setPosts(response.data.data);
      // console.log(response.data);
      console.log(response.data.data.refunded);
    };
    axiosPosts();
  }, []);
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={style.footer}>
          ...
          >
            ...
            >
              Your Transactions Information is here:
            </Text>

            {/* <View style={{ marginTop: -90 }}>{usePosts}</View> */}
            <View style={{ marginLeft: -410 }}></View>
