...
const Pendingvendor1 = ({ navigation }) => {
  ...
  const PendingVendor3 = pendingVendorRequest?.map((request) => {
    return (
      <View>
        <Text>{req?.fname}</Text>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={style.footer}>
          ...
          >
            ...
            >
              Your All users information is here:
            </Text>

            {/* <View style={{ marginTop: -90 }}>{usePosts}</View> */}
            <View style={{ marginLeft: -350 }}></View>
