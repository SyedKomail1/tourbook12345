...
const CarHomeScreen = ({navigation}) => {
  const optionsList = [
    {title: 'Buy a Home', img: require('../../assets/caronboard1.jpg')},
    {title: 'Rent a Home', img: require('../../assets/caronboard1.jpg')},
  ];
  ...
  const Card = ({house}) => {
    return (
      <Pressable
        activeOpacity={0.8}
        onPress={() => navigation.navigate('CarDetailScreen', house)}>
