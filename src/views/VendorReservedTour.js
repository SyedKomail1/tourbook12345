...
const VendorReservedTour = ({ navigation }) => {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={style.footer}>
          ...
          >
            ...
            >
              Reserved Tours Requests Information is here:
            </Text>

            {/* <View style={{ marginTop: -90 }}>{usePosts}</View> */}
            <View style={{ marginLeft: -460 }}></View>
...
export default VendorReservedTour;
